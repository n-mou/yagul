...
// and panicking when an error is found. Although anicking whenever an error is found
// is not a proper way of handling the, sometimes it is the right way to do so, and
