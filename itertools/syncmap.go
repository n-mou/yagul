...
// developed it when I created the examples of this module but due to how [sync.Map]
// is implemented, the iterator would need to traverse all the map elements
